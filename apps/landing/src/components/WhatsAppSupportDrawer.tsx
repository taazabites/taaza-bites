...
/** Prefill for the floating homepage WhatsApp CTA */
export const WHATSAPP_CONSULTATION_MESSAGE = `Hi Taazabites Nutrition Team! I'm interested in a custom meal plan and would like a consultation.
